...
def pawn_from_element(
  ...
  return PawnRecord(
    ...
    roof_kind=save.roof_kind_for_pawn(pid),
    terrain_kind=save.terrain_kind_for_pawn(pid),
    map_kind=save.map_kind_for_pawn(pid),
    caravan=pid in save.pawn_to_caravan,
    hair_def=hair_def,
