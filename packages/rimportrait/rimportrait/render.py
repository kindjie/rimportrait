...
SINGLE_PROMPT_INSTRUCTION = (
  ...
  "Prioritize, in order: xenotype/race, age, role, hair/beard, "
  "wielded weapon, visible face, expression, armor/headgear, "
  "visible implants/injuries, posture, immediate setting, colony "
  "situation. Do not omit the wielded weapon or hair description if "
  "the block lists them - the image model drops late details, so "
  "place these early in the paragraph.\n"
  "When a helmet or hat is carried/cradled/tucked rather than worn, "
  "describe its interior as clearly empty (lined padding, hollow, "
  "no face, no head, no eyes inside) - models otherwise fill the "
  "negative space with a severed head.\n"
  "Keep background secondary. Avoid "
...
FAMILY_PROMPT_INSTRUCTION = (
  ...
  "back so faces are visible; when carried/cradled, describe the "
  "interior as clearly empty (lined padding, hollow, no face/head "
  "inside). Do not drop a pawn's wielded weapon or hair description "
  "if the block lists them - the image model drops late details, "
  "so anchor weapons and hair early in the paragraph for each "
  "person. Use gear and weapons as portrait props, not action "
  "clutter."
)
